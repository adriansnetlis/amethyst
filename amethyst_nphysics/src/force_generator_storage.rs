...
use nphysics3d::{
    force_generator::{
        ForceGeneratorSet as NpForceGeneratorSet,
        ForceGenerator as NpForceGenerator,
    },
    object::{
...
impl<N: PtReal, S: NpBodySet<N> + 'static> NpForceGeneratorSet<N, S> for ForceGeneratorStorage<N, S> {
